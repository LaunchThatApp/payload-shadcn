            ...
            _jsx("div", {
                ...
                children: payload.map((item, index)=>{
                    ...
                    return _jsx("div", {
                        ...
                        children: formatter && item?.value !== undefined && item.name ? formatter(item.value, item.name, item, index, item.payload) : _jsxs(_Fragment, {
                            children: [
                                itemConfig?.icon ? _jsx(itemConfig.icon, {}) : !hideIndicator && _jsx("div", {
    ...
    return _jsx("div", {
        ...
        children: payload.map((item)=>{
            ...
            return _jsxs("div", {
                ...
                children: [
                    itemConfig?.icon && !hideIcon ? _jsx(itemConfig.icon, {}) : _jsx("div", {
